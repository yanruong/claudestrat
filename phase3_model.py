...
OUT = '/home/user/claudestrat/output/phase3'
...
df = pd.read_csv('/home/user/claudestrat/data/features.csv', index_col=0, parse_dates=True)
df = df.sort_index()
...
with open('/home/user/claudestrat/data/phase3_results.json', 'w') as f:
